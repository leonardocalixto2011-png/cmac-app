      ...
      blocks: [
        {
          ...
          ul: [
            ...
            `Delivery typically takes ${SHIPPING.deliveryWeeks.min} to ${SHIPPING.deliveryWeeks.max} weeks depending on the item and your province. The estimate is shown at checkout before you pay.`,
      ...
      blocks: [
        {
          ...
          ul: [
            ...
            `La livraison prend généralement de ${SHIPPING.deliveryWeeks.min} à ${SHIPPING.deliveryWeeks.max} semaines selon l'article et votre province. L'estimation est affichée au moment du paiement.`,
