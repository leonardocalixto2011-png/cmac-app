...
- Products are cosmetic at-home tools (LED light, microcurrent, EMS, cooling, cleansing, nail and foot care), textile accessories, a hair range (satin pillowcase, scrunchie, sleep set, scalp massager) and a small cozy-home range (hooded blanket, velvet fall decor). They are **not medical devices** and the store makes appearance-only claims: no treatment, healing or "clinically proven" wording.
