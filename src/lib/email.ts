...
const COPY = {
  en: {
    ...
    confirmLead: `Thanks for your order. We're getting it ready — you'll receive a tracking number by email as soon as it ships. Delivery usually takes ${SHIPPING.deliveryWeeks.min} to ${SHIPPING.deliveryWeeks.max} weeks.`,
    items: "Your order",
    subtotal: "Subtotal",
    shipping: "Shipping",
    free: "Free",
  ...
  fr: {
    ...
    confirmLead: `Merci pour votre commande. On la prépare — vous recevrez un numéro de suivi par courriel dès son expédition. La livraison prend généralement de ${SHIPPING.deliveryWeeks.min} à ${SHIPPING.deliveryWeeks.max} semaines.`,
