...
import { SHIPPING, holidayCutoff } from "@/lib/brand";
...
export function Marquee() {
  ...
  const date = cutoff?.toLocaleDateString(locale === "fr" ? "fr-CA" : "en-CA", { month: "long", day: "numeric" });
  const items = [
    ...(date ? [t("marquee.holiday", { date })] : []),
    t("marquee.1", { free }),
    t("marquee.2"),
    t("marquee.3"),
    t("marquee.4"),
